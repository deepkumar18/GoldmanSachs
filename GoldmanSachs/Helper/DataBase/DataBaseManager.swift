...
class DatabaseManager {
    ...
    var dataBaseQueue: DispatchQueue = DispatchQueue(label: "com.GoldmanSachs.databaseQueue")
    
    var persistentStoreCoordinator: NSPersistentStoreCoordinator
    
    // MARK: Properties
    static let storeFileName = "GoldmanSachs.sqlite"
    
    // The managed object model
    static let managedObjectModel: NSManagedObjectModel = { () -> NSManagedObjectModel in
        let modelURL = Bundle.main.url(forResource: "GoldmanSachs", withExtension: "momd")
